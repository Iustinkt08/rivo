...
Add to your project `.claude/settings.json` (this skill is installed project-level):
...
```json
{
  "hooks": {
    "PreToolUse": [
      {
        "matcher": "Edit",
        "hooks": [{ "type": "command", "command": "node $CLAUDE_PROJECT_DIR/.claude/skills/strategic-compact/suggest-compact.js" }]
      },
      {
        "matcher": "Write",
        "hooks": [{ "type": "command", "command": "node $CLAUDE_PROJECT_DIR/.claude/skills/strategic-compact/suggest-compact.js" }]
